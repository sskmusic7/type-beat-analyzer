              ...
              <div className="mb-8 flex flex-wrap">
                <div className="mr-8 mb-4 flex">
                  <figure className="mr-4 shrink-0">
                    <Link to={`/user/1`} className="relative block">
                      <img
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <Link to={`/user/2`} className="block text-accent">
                ...
                <div className="mb-4 flex">
                  <figure className="mr-4 shrink-0">
                    <Link to={`/user/4`} className="relative block">
                      <img
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <Link to={`/user/6`} className="block text-accent">
